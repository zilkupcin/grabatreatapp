...
public class AppConstants {
  ...
  public static final String VERSION_NAME = "2.12.2";
  public static String INITIAL_URL = "exp://exp.host/@grabatreatapp/grabatreat";
  public static final String SHELL_APP_SCHEME = "expcc2bf4c0652740ecbd4cdd4015bb9e58";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@grabatreatapp/grab-a-treat-app", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40grabatreatapp%2Fgrab-a-treat-app%2F1.0.0%2F30103bd808bd0cdacac8d5a5b376d27c-34.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
